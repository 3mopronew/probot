...
.setStyle("SUCCESS"),
new MessageButton()
.setCustomId("design_close")
.setLabel("إِغْلَاق")
.setStyle("SECONDARY"),
new MessageButton()
.setCustomId("design_delete")
.setLabel("حَذْف")
.setStyle("DANGER"))
...
if (interaction.customId === "design_create") {
...
const ticketDataS = JSON.parse(fs.readFileSync("./━━━━━━━━━━━━━━━/Database/TKT2.json", "utf-8"))
...
fs.writeFileSync("./━━━━━━━━━━━━━━━/Database/TKT2.json", JSON.stringify(ticketData))}

//════════════════════

if (interaction.customId === "design_close") {

const ticketData = JSON.parse(fs.readFileSync("./━━━━━━━━━━━━━━━/Database/TKT2.json", "utf-8"))
...
if (interaction.customId === "design_open") {
...
if (interaction.customId === "design_delete") {
...
fs.writeFileSync("./━━━━━━━━━━━━━━━/Database/TKT2.json", JSON.stringify(ticketData))}}, 5000 )}
